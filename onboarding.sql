...
(
    ...
    uen_confidence numeric,
    sg_phone text COLLATE pg_catalog."default",
    sg_postcode text COLLATE pg_catalog."default",
    sg_markers text[] COLLATE pg_catalog."default",
    employee_bracket text COLLATE pg_catalog."default",
    locations_est integer,
...
(
    ...
    tenant_id integer,
    public_emails text[] COLLATE pg_catalog."default",
...
CREATE TABLE IF NOT EXISTS public.customer_seeds
(
    id bigserial NOT NULL,
    tenant_id integer NOT NULL,
    seed_name text COLLATE pg_catalog."default" NOT NULL,
    domain text COLLATE pg_catalog."default",
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    CONSTRAINT customer_seeds_pkey PRIMARY KEY (id)
);

ALTER TABLE IF EXISTS public.customer_seeds
...
(
    ...
    signal_key text COLLATE pg_catalog."default" NOT NULL,
    value jsonb NOT NULL,
    source text COLLATE pg_catalog."default" NOT NULL,
    observed_at timestamp with time zone NOT NULL DEFAULT now(),
    CONSTRAINT icp_evidence_pkey PRIMARY KEY (id)
);

ALTER TABLE IF EXISTS public.icp_evidence
    ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS public.icp_intake_responses
(
    id bigserial NOT NULL,
    tenant_id integer NOT NULL,
    submitted_by text COLLATE pg_catalog."default" NOT NULL,
    submitted_at timestamp with time zone NOT NULL DEFAULT now(),
    answers_jsonb jsonb NOT NULL,
    CONSTRAINT icp_intake_responses_pkey PRIMARY KEY (id)
);

ALTER TABLE IF EXISTS public.icp_intake_responses
    ENABLE ROW LEVEL SECURITY;

CREATE TABLE IF NOT EXISTS public.icp_research_artifacts
(
    id bigserial NOT NULL,
    tenant_id bigint NOT NULL,
    company_hint text COLLATE pg_catalog."default",
    company_id bigint,
    path text COLLATE pg_catalog."default" NOT NULL,
    source_urls text[] COLLATE pg_catalog."default" NOT NULL,
    snapshot_md text COLLATE pg_catalog."default" NOT NULL,
    fit_signals jsonb,
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    updated_at timestamp with time zone NOT NULL DEFAULT now(),
    ai_metadata jsonb NOT NULL DEFAULT '{}'::jsonb,
    CONSTRAINT icp_research_artifacts_pkey PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS public.research_import_runs
(
    id bigserial NOT NULL,
    tenant_id bigint NOT NULL,
    ...
    ai_metadata jsonb NOT NULL DEFAULT '{}'::jsonb,
    CONSTRAINT research_import_runs_pkey PRIMARY KEY (id)
);
...
(
    service_key text COLLATE pg_catalog."default" NOT NULL,
    last_id bigint,
    last_uen text COLLATE pg_catalog."default",
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT service_progress_pkey PRIMARY KEY (service_key)
);
...
(
    ...
    source text COLLATE pg_catalog."default" NOT NULL DEFAULT 'web_discovery'::text,
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    ai_metadata jsonb NOT NULL DEFAULT '{}'::jsonb,
    CONSTRAINT staging_global_companies_pkey PRIMARY KEY (id)
);
...
(
    ...
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT tenant_company_profiles_pkey PRIMARY KEY (tenant_id)
);
...
ALTER TABLE IF EXISTS public.company_enrichment_runs
    ADD CONSTRAINT company_enrichment_runs_tenant_id_fkey FOREIGN KEY (tenant_id)
...
ALTER TABLE IF EXISTS public.lead_emails
    ...
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
CREATE INDEX IF NOT EXISTS idx_lead_emails_company
    ON public.lead_emails(company_id);
...
ALTER TABLE IF EXISTS public.tenant_company_profiles
    ADD CONSTRAINT tenant_company_profiles_tenant_id_fkey FOREIGN KEY (tenant_id)
    REFERENCES public.tenants (tenant_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS tenant_company_profiles_pkey
    ON public.tenant_company_profiles(tenant_id);
